...
# Define paths
WEIGHTS_DIR = r"C:/Users/yadav/Documents/Person and PPE detection/weights"
PERSON_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_person.pt")
PPE_MODEL_PATH = os.path.join(WEIGHTS_DIR, "best_ppe.pt")
INPUT_DIR = r"C:/Users/yadav/Documents/Person and PPE detection/input_directory"
OUTPUT_DIR = r"C:/Users/yadav/Documents/Person and PPE detection/output_directory"
    ...
    for image_file in image_files:
        ...
        try:
            ...
            for i, box in enumerate(boxes):
                ...
                # Print detected person details
                print(f"Detected {class_name} with confidence {conf:.2f}% in {image_file}")
                ...
                if class_name.lower() == "person":
                    ...
                    # Run PPE detection on cropped person
...
def detect_ppe(model, image_path, full_image, x_offset, y_offset):
    ...
    for box in boxes:
        ...
        # Draw bounding box and label on cropped image
        ...
        # Map PPE detection to full image
        ...
        # Print detected PPE details
        print(f"Detected {class_name} with confidence {conf:.2f}% in {os.path.basename(image_path)}")

    # Save PPE-annotated cropped image
